...
if(!$query = mysql_query("UPDATE SERVICE_CATEGORY SET CATEGORY_NUM='$cat_num' , CATEGORY_DESCRIPTION='$cat_desc'
		  WHERE CATEGORY_NUM = '$cat_num'")) {
die(mysql_error());
		  }
		  ?>
	<font size="10" color="blue">DATA HAS BEEN UPDATED FROM THE SERVICE CATEGORY DATABASE!</font>
...
if ($r = mysql_query($query))
{
	...
	while ($row = mysql_fetch_array($r)){
		print "<p>{$row['CATEGORY_NUM']}&nbsp;{$row['CATEGORY_DESCRIPTION']}";
}
}
}
?>

...
<table border="3">
<tr bgcolor="A5FFE7">
<font size="12" color="black"><b>Service Category Delete Page</b></font>
</tr>
<tr>
...
$res = mysql_query("DELETE FROM SERVICE_CATEGORY WHERE CATEGORY_NUM ='$cat_num'");
...
if(!$query = mysql_query("DELETE FROM SERVICE_CATEGORY WHERE CATEGORY_NUM ='$cat_num'")) {
die(mysql_error());
}
?>
	<font size="8" color="blue">DATA HAS BEEN DELETED FROM THE SERVICE CATEGORY DATABASE!</font>
